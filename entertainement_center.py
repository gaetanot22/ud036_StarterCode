...
# Collect all movie in a list in order to pass to the open_movies_pages func.
movies = [StarWarsI, StarWarsII, StarWarsIII, StarWarsIV, StarWarsV,
          StarWarsVI, StarWarsVII, StarWarsVIII, StarWarsStoryI]
